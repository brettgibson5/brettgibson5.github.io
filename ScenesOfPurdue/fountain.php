...
?>
<h3 style="font-size:95%;">{ engineering fountain }</h3>
</div>
<hr />
<!--display menu-->
<div id="menu">
...
<?php
	...
	$_SESSION["page"]="location: fountain.php";
	$_SESSION["url"]="fountain.php";
	//form sql query selecting address book with same username as session
	$sql="SELECT * FROM image WHERE CategoryID='engFountain'";
