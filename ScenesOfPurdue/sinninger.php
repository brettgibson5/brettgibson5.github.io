...
<?php
	...
	$_SESSION["page"]="location: sinninger.php";
	$_SESSION["url"]="sinninger.php";
	//form sql query selecting address book with same username as session
	$sql="SELECT * FROM image WHERE CategoryID='Sinninger'";
